...
export const BatchProcessingSettings: React.FC<BatchProcessingSettingsProps> = ({
  ...
  return (
    <ExpandableSection
      ...
      onToggle={onToggle}
      additionalClasses="border-yellow-200 dark:border-yellow-800"
      headerBgColor="bg-yellow-50 dark:bg-yellow-900/20"
      contentBgColor="bg-yellow-50 dark:bg-yellow-900/20"
        ...
        <div className="flex items-start justify-between mb-3">
          ...
          <div className="flex items-center">
            <input
              id="enable-batch"
              type="checkbox"
              className="h-5 w-5 rounded border-gray-300 text-yellow-600 focus:ring-yellow-500 disabled:opacity-50"
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="w-16 px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-right disabled:bg-gray-100 disabled:opacity-50"
                  disabled={disabled}
                />
              </div>
            ...
            <div>
              ...
              <div className="flex items-center">
                ...
                <input
                  ...
                  className="w-24 px-2 py-1 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200 text-right disabled:bg-gray-100 disabled:opacity-50"
                  disabled={disabled}
                />
              </div>
              <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">
